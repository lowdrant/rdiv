...
from numpy import (argmin, array, diag, eye, fill_diagonal, inf, log10,
                   newaxis, tril, triu)
...
if __name__ == '__main__':
    ...
    diffmat = triu(abs(mult*res_arr - res_arr.T))  # absolute difference is symm
    ...
    print('R1={}, R2={}'.format(r1*10**powOf10, r2))
